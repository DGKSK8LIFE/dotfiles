...
static const char *fonts[] = {
    "hack:size=10", "JoyPixels:pixelsize=12:antialias=true:autohint=true"};
static char dmenufont[] = "monospace:size=12";
static char normbgcolor[] = "#282828";
static char normbordercolor[] = "#a89984";
static char normfgcolor[] = "#ebdbb2";
static char selfgcolor[] = "#ebdbb2";
static char selbordercolor[] = "#606449";
static char selbgcolor[] = "#A4774B";
...
static Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_e, spawn,
     SHCMD("st -e abook -C ~/.config/abook/abookrc --datafile "
    ...
    {MODKEY|Mod1Mask, XK_space, spawn, SHCMD("qwerty")},
    {MODKEY|Mod1Mask|ControlMask, XK_space, spawn, SHCMD("dvorak")},
    {MODKEY, XK_space, zoom, {0}},
    {MODKEY | ShiftMask, XK_space, togglefloating, {0}},

    {0, XK_Print, spawn, SHCMD("flameshot screen -p $HOME/Pictures/screenshots && flameshot screen -c")},
